...
if bot1:
    bot1.start()
    bot1.join_chat("TITANIUM_XYZ")
    bot1.join_chat("TitaniumChats")
if bot2:
    bot2.start()
    bot2.join_chat("TITANIUM_XYZ")
    bot2.join_chat("TitaniumChats")
if bot3:
    bot3.start()
    bot3.join_chat("TITANIUM_XYZ")
    bot3.join_chat("TitaniumChats")
if bot4:
    bot4.start()
    bot4.join_chat("TITANIUM_XYZ")
    bot4.join_chat("TitaniumChats")
if bot5:
    bot5.start()
    bot5.join_chat("TITANIUM_XYZ")
    bot5.join_chat("TitaniumChats")
if bot6:
    bot6.start()
    bot6.join_chat("TITANIUM_XYZ")
    bot6.join_chat("TitaniumChats")
if bot7:
    bot7.start()
    bot7.join_chat("TITANIUM_XYZ")
    bot7.join_chat("TitaniumChats")
if bot8:
    bot8.start()
    bot8.join_chat("TITANIUM_XYZ")
    bot8.join_chat("TitaniumChats")
if bot9:
    bot9.start()
    bot9.join_chat("TITANIUM_XYZ")
    bot9.join_chat("TitaniumChats")
if bot:
    bot.start()
    bot.join_chat("TITANIUM_XYZ")
    bot.join_chat("TitaniumChats")
if bot11:
    bot11.start()
    bot11.join_chat("TITANIUM_XYZ")
    bot11.join_chat("TitaniumChats")
if bot12:
    bot12.start()
    bot12.join_chat("TITANIUM_XYZ")
    bot12.join_chat("TitaniumChats")
if bot13:
    bot13.start()
    bot13.join_chat("TITANIUM_XYZ")
    bot13.join_chat("TitaniumChats")
if bot14:
    bot14.start()
    bot14.join_chat("TITANIUM_XYZ")
    bot14.join_chat("TitaniumChats")
if bot15:
    bot15.start()
    bot15.join_chat("TITANIUM_XYZ")
    bot15.join_chat("TitaniumChats")
if bot16:
    bot16.start()
    bot16.join_chat("TITANIUM_XYZ")
    bot16.join_chat("TitaniumChats")
if bot17:
    bot17.start()
    bot17.join_chat("TITANIUM_XYZ")
    bot7.join_chat("TitaniumChats")
if bot18:
    bot18.start()
    bot18.join_chat("TITANIUM_XYZ")
    bot18.join_chat("TitaniumChats")
if bot19:
    bot19.start()
    bot19.join_chat("TITANIUM_XYZ")
    bot19.join_chat("TitaniumChats")
if bot20:
    bot20.start()
    bot20.join_chat("TITANIUM_XYZ")
    bot20.join_chat("TitaniumChats")
if bot21:
    bot21.start()
    bot21.join_chat("TITANIUM_XYZ")
    bot21.join_chat("TitaniumChats")
if bot22:
    bot22.start()
    bot22.join_chat("TITANIUM_XYZ")
    bot22.join_chat("TitaniumChats")
if bot23:
    bot23.start()
    bot23.join_chat("TITANIUM_XYZ")
    bot23.join_chat("TitaniumChats")
if bot24:
    bot24.start()
    bot24.join_chat("TITANIUM_XYZ")
    bot24.join_chat("TitaniumChats")
if bot25:
    bot25.start()
    bot25.join_chat("TITANIUM_XYZ")
    bot25.join_chat("TitaniumChats")
if bot26:
    bot26.start()
    bot26.join_chat("TITANIUM_XYZ")
    bot26.join_chat("TitaniumChats")
if bot27:
    bot27.start()
    bot27.join_chat("TITANIUM_XYZ")
    bot27.join_chat("TitaniumChats")
if bot28:
    bot28.start()
    bot28.join_chat("TITANIUM_XYZ")
    bot28.join_chat("TitaniumChats")
if bot29:
    bot29.start()
    bot29.join_chat("TITANIUM_XYZ")
    bot29.join_chat("TitaniumChats")
if bot30:
    bot30.start()
    bot30.join_chat("TITANIUM_XYZ")
    bot30.join_chat("TitaniumChats")
if bot31:
    bot31.start()
    bot31.join_chat("TITANIUM_XYZ")
    bot31.join_chat("TitaniumChats")
if bot32:
    bot32.start()
    bot32.join_chat("TITANIUM_XYZ")
    bot32.join_chat("TitaniumChats")
if bot33:
    bot33.start()
    bot33.join_chat("TITANIUM_XYZ")
    bot33.join_chat("TitaniumChats")
if bot34:
    bot34.start()
    bot34.join_chat("TITANIUM_XYZ")
    bot34.join_chat("TitaniumChats")
if bot35:
    bot35.start()
    bot35.join_chat("TITANIUM_XYZ")
    bot35.join_chat("TitaniumChats")
if bot36:
    bot36.start()
    bot36.join_chat("TITANIUM_XYZ")
    bot36.join_chat("TitaniumChats")
if bot37:
    bot37.start()
    bot37.join_chat("TITANIUM_XYZ")
    bot37.join_chat("TitaniumChats")
if bot38:
    bot38.start()
    bot38.join_chat("TITANIUM_XYZ")
    bot38.join_chat("TitaniumChats")
if bot39:
    bot39.start()
    bot39.join_chat("TITANIUM_XYZ")
    bot39.join_chat("TitaniumChats")
if bot40:
    bot40.start()
    bot40.join_chat("TITANIUM_XYZ")
    bot40.join_chat("TitaniumChats")
if bot41:
    bot41.start()
    bot41.join_chat("TITANIUM_XYZ")
    bot41.join_chat("TitaniumChats")
if bot42:
    bot42.start()
    bot42.join_chat("TITANIUM_XYZ")
    bot42.join_chat("TitaniumChats")
if bot43:
    bot43.start()
    bot43.join_chat("TITANIUM_XYZ")
    bot43.join_chat("TitaniumChats")
if bot44:
    bot44.start()
    bot44.join_chat("TITANIUM_XYZ")
    bot44.join_chat("TitaniumChats")
if bot45:
    bot45.start()
    bot45.join_chat("TITANIUM_XYZ")
    bot45.join_chat("TitaniumChats")
if bot46:
    bot46.start()
    bot46.join_chat("TITANIUM_XYZ")
    bot46.join_chat("TitaniumChats")
if bot47:
    bot47.start()
    bot47.join_chat("TITANIUM_XYZ")
    bot47.join_chat("TitaniumChats")
if bot48:
    bot48.start()
    bot48.join_chat("TITANIUM_XYZ")
    bot48.join_chat("TitaniumChats")
if bot49:
    bot49.start()
    bot49.join_chat("TITANIUM_XYZ")
    bot49.join_chat("TitaniumChats")
if bot50:
    bot50.start()
    bot50.join_chat("TITANIUM_XYZ")
    bot50.join_chat("TitaniumChats")

print("🎉 Successfully Deployed 🎉 @TITANIUMXD")
print("Enjoy! Do visit @Titanium_Xyz")
